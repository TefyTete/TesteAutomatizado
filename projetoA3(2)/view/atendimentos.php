        ...
        <section class="p-2">
            <table class="table table-striped">
                ...
                foreach ($consulta as $linha) {
                    ...
                    $respostaAtendimento = str_replace("\n", "<br>", $linha['respostaAtendimento']);
                ?>
                <tr>
                    ...
                    <td style="white-space: pre-line; line-height: 0.8;"><?php echo $respostaAtendimento; ?></td>
                ...
                <tr>
                    <td colspan="6">
                        <a class="btn btn-primary" href="cadastrarAtendimento.php">CADASTRAR
                    </td>
                    <td>
